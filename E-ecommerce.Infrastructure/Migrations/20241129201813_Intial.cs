    ...
    public partial class Intial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FavoriteCarts", x => x.ID);
                    table.ForeignKey(
                        name: "FK_FavoriteCarts_AspNetUsers_CustomerID",
                        column: x => x.CustomerID,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DiscountExpireDate = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FavoriteCartProducts", x => new { x.ProductID, x.FavoriteCartID });
                    table.ForeignKey(
                        name: "FK_FavoriteCartProducts_FavoriteCarts_FavoriteCartID",
                        column: x => x.FavoriteCartID,
                        principalTable: "FavoriteCarts",
                        principalColumn: "ID");
                    table.ForeignKey(
                        name: "FK_FavoriteCartProducts_Products_ProductID",
                        column: x => x.ProductID,
                        principalTable: "Products",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FavoriteCartProducts_FavoriteCartID",
                table: "FavoriteCartProducts",
                column: "FavoriteCartID");

            migrationBuilder.CreateIndex(
                name: "IX_FavoriteCarts_CustomerID",
                table: "FavoriteCarts",
                column: "CustomerID");
